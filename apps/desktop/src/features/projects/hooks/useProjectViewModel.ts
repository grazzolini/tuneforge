...
export function useProjectViewModel() {
  ...
  return {
    ...
    chordsQuerySettled: chordsQuery.isSuccess || chordsQuery.isError,
    chordsQuerySucceeded: chordsQuery.isSuccess,
    ...
    lyricsQuerySettled: lyricsQuery.isSuccess || lyricsQuery.isError,
    lyricsQuerySucceeded: lyricsQuery.isSuccess,
