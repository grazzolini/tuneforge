...
| [Omnizart](https://github.com/Music-and-Culture-Technology-Lab/omnizart) | Exclude | License is permissive, but the stack is too old/heavy for TuneForge packaging. | Beat/downbeat support exists, but it depends on old TensorFlow-era tooling and does not fit Python 3.14 desktop packaging. Upstream release freshness also makes it a poor fit for a new dependency. |
