...
- Keep built-in chord generation available when the desktop-only ONNX Advanced Chords stack is unavailable, unsupported, explicitly excluded, or disabled by the mobile runtime platform.
