...
WHISPER_MODEL_INSTALLER="$ANDROID_MAIN/java/com/tuneforge/desktop/WhisperModelInstaller.java"
...
WHISPER_MODEL_INSTALLER_SOURCE="$ANDROID_JAVA_SOURCE/WhisperModelInstaller.java"
...
cp "$WHISPER_MODEL_INSTALLER_SOURCE" "$WHISPER_MODEL_INSTALLER"
